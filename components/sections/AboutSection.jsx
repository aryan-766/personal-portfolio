...
const SOCIALS = profile.socials.map(s => ({ Icon: ICON_MAP[s.label], href: s.href, label: s.label })).filter(s => s.Icon)
...
export default function AboutSection() {
  ...
  return (
    <section ref={sectionRef} className={styles.section}>
      ...
      {/* â”€â”€ Left: photo + signature + socials â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      ...
      {/* â”€â”€ Right: content â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className={styles.marqueeTrack}>
            {[...WHO_ITEMS, ...WHO_ITEMS].map((item, i) => (
              <span key={i} className={styles.marqueeItem}>
                {item}
                <span className={styles.marqueeDot}>Â·</span>
              </span>
            ))}
          </div>
        </div>
