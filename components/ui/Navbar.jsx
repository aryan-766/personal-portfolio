...
const EXP_IDX = 3 + PROJECT_COUNT
const PUBS_IDX = EXP_IDX + 1
const CONTACT_IDX = PUBS_IDX + 2

const NAV_ITEMS = [
  { label: 'Home',         idx: 0 },
  { label: 'About',        idx: 2 },
  { label: 'Projects',     idx: 3 },
  { label: 'Experience',   idx: EXP_IDX },
  { label: 'Publications', idx: PUBS_IDX },
  { label: 'Contact',      idx: CONTACT_IDX },
]
