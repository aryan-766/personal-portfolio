...
export const metadata = {
  ...
  title: {
    default: 'Aryan Jain | Full Stack Developer',
  ...
  authors: [{ name: 'Aryan Jain', url: SITE_URL }],
  creator: 'Aryan Jain',
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Aryan Jain | Full Stack Developer Portfolio',
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: 'Aryan Jain',
              url: SITE_URL,
              email: 'aryan070606@gmail.com',
              jobTitle: 'Full Stack Developer',
              sameAs: [
                'https://github.com/ARYANKhushalani',
                'https://www.linkedin.com/in/ARYAN-khushalani-760217136',
                'https://medium.com/@ARYANkhushalani',
                'https://www.instagram.com/ARYAN.create',
                'https://www.youtube.com/@ARYAN.create',
              ],
            }),
          }}
        />
